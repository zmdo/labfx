    ...
    public DockTitleBar(DockNode dockNode) {
        ...
        dockNode.closableProperty().addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean oldValue, Boolean newValue) {
                if (Boolean.FALSE.equals(newValue) && getChildren().contains(closeButton)) {
                    getChildren().remove(closeButton);
                } else if (Boolean.TRUE.equals(newValue) && !getChildren().contains(closeButton)) {
        ...
        getChildren().addAll(label, fillPane, stateButton);
